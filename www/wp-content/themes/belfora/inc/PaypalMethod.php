 ...
 */
class PaypalMethod extends WC_Payment_Gateway {
    ...
    protected function setup_properties() {
        ...
        $this->method_description = 'Приходит заявка и администратор выставляет счет самостоятельно через аккаунт paypal';
    ...
    public function init_form_fields() {
        $this->form_fields = array(
            ...
            'instructions'       => array(
                ...
                'default'     => 'Администратор выставит счет через аккаунт paypal',
                'desc_tip'    => true,
            ),
